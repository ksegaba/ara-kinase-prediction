...
# instances = '/home/seguraab/ara-kinase-prediction/data/instances_dataset_1.txt'
...
# Creating a DataFrame from the gene_pairs_dict
...
# gene_pairs.to_csv(
#     "data/Kinase_genes/features/TAIR10_kinases_features_epigenetics.txt", sep='\t', index=False)
gene_pairs.to_csv(
    "data/20250403_melissa_ara_data/features/20250403_melissa_ara_features_for_binary_clf_epigenetics.txt", sep='\t', index=False)
